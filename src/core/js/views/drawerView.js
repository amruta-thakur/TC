define([
    ...
    var DrawerView = Backbone.View.extend({
        ...
        openCustomView: function(view, hasBackButton) {
            ...
            /*added code display title on drawer also changes on drawer.hbs*/
            if(view.hasClass('resources')){
                this.$('.resource-name').html("Resources");
            }else if(view.hasClass('page-level-progress')){
                this.$('.resource-name').html("Topic List");
            }else{
                 this.$('.resource-name').html("");
            }
            /***************End*******************/
         },
